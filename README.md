...
- Веб: `https://<домен>/mini-app/?web=1`, приглашение: `?web=1&invite=<token>`. Ссылки для приглашений **всегда** содержат `web=1`, иначе в обычном браузере на телефоне не включается вход через Telegram Login Widget.
- Ссылка «Скопировать приглашение» собирается из **`APP_URL`** на сервере: `https://<APP_URL>/mini-app/?web=1&invite=…` (короткая каноническая ссылка, без мусора из WebView). Задайте `APP_URL` на тот же публичный домен, с которого открывают приложение.
