...
function buildHelpHtml(): string {
  return [
    ...
    "",
    "<b>Команды в этом чате</b> (личные счета)",
    "/start — приветствие с постером",
    "/add — добавить счёт по шагам",
    "/accounts — список счетов",
    "/help — эта справка",
    "",
    "<b>Команда до 5 человек</b> — в мини-приложении: переключение пространства, приглашения и общая книга. Здесь в чате всегда показываются только личные счета."
  ].join("\n");
}
